...
static const char *sm4_selftest (void) { return 0; }
...
gcry_cipher_spec_t _gcry_cipher_spec_sm4 =
  {
    ...
    NULL, NULL,
    GRUB_UTIL_MODNAME("gcry_sm4")
  };


GRUB_MOD_INIT(gcry_sm4)
{
  grub_cipher_register (&_gcry_cipher_spec_sm4);
}

GRUB_MOD_FINI(gcry_sm4)
{
  grub_cipher_unregister (&_gcry_cipher_spec_sm4);
}
