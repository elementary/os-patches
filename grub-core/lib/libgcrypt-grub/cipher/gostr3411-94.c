...
gcry_md_spec_t _gcry_digest_spec_gost3411_94 =
  {
    ...
    ,
    GRUB_UTIL_MODNAME("gcry_gostr3411_94")
    .blocksize = 32
  };
...
GRUB_MOD_INIT(gcry_gostr3411_94)
{
  grub_md_register (&_gcry_digest_spec_gost3411_94);
  grub_md_register (&_gcry_digest_spec_gost3411_cp);
}

GRUB_MOD_FINI(gcry_gostr3411_94)
{
  grub_md_unregister (&_gcry_digest_spec_gost3411_94);
  grub_md_unregister (&_gcry_digest_spec_gost3411_cp);
}
