...
gcry_cipher_spec_t _gcry_cipher_spec_salsa20 =
  {
    ...
    salsa20_setiv
    ,
    GRUB_UTIL_MODNAME("gcry_salsa20")
  };
...
GRUB_MOD_INIT(gcry_salsa20)
{
  grub_cipher_register (&_gcry_cipher_spec_salsa20);
  grub_cipher_register (&_gcry_cipher_spec_salsa20r12);
}

GRUB_MOD_FINI(gcry_salsa20)
{
  grub_cipher_unregister (&_gcry_cipher_spec_salsa20);
  grub_cipher_unregister (&_gcry_cipher_spec_salsa20r12);
}
