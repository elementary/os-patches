...
gcry_md_spec_t _gcry_digest_spec_stribog_256 =
  {
    ...
    ,
    GRUB_UTIL_MODNAME("gcry_stribog")
    .blocksize = 64
  };
...
{
  grub_md_register (&_gcry_digest_spec_stribog_256);
  grub_md_register (&_gcry_digest_spec_stribog_512);
}

GRUB_MOD_FINI(gcry_stribog)
{
  grub_md_unregister (&_gcry_digest_spec_stribog_256);
  grub_md_unregister (&_gcry_digest_spec_stribog_512);
}
