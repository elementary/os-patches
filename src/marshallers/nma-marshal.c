...
void
_nma_marshal_VOID__POINTER_POINTER_STRING_POINTER_UINT_POINTER_POINTER (GClosure     *closure,
...
{
  typedef void (*GMarshalFunc_VOID__POINTER_POINTER_STRING_POINTER_UINT_POINTER_POINTER) (gpointer     data1,
                                                                                          gpointer     arg_1,
                                                                                          gpointer     arg_2,
                                                                                          gpointer     arg_3,
                                                                                          gpointer     arg_4,
  ...
  callback = (GMarshalFunc_VOID__POINTER_POINTER_STRING_POINTER_UINT_POINTER_POINTER) (marshal_data ? marshal_data : cc->callback);
...
void
_nma_marshal_VOID__STRING_BOXED (GClosure     *closure,
                                 GValue       *return_value G_GNUC_UNUSED,
                                 guint         n_param_values,
                                 const GValue *param_values,
                                 gpointer      invocation_hint G_GNUC_UNUSED,
...
void
_nma_marshal_VOID__UINT_STRING_STRING (GClosure     *closure,
                                       GValue       *return_value G_GNUC_UNUSED,
                                       guint         n_param_values,
                                       const GValue *param_values,
                                       gpointer      invocation_hint G_GNUC_UNUSED,
...
void
_nma_marshal_VOID__UINT_UINT (GClosure     *closure,
                              GValue       *return_value G_GNUC_UNUSED,
                              guint         n_param_values,
                              const GValue *param_values,
                              gpointer      invocation_hint G_GNUC_UNUSED,
